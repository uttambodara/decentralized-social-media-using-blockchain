...
const style = {
  ...
  searchBar: `flex items-center bg-[white] p-2 rounded-3xl text-black`,
  searchIcon: `text-[#8899a6] mr-2`,
  inputBox: `bg-transparent outline-none`,
  section: `bg-[white] my-6 rounded-xl overflow-hidden text-black`,
  title: `p-2 font-bold text-lg`,
  showMore: `p-2 text-[#2196f3] text-sm cursor-pointer hover:bg-[#F9EEFB]`,
  item: `flex items-center p-3 my-2 hover:bg-[#F9EEFB] cursor-pointer`,
  newsItemLeft: `flex-1`,
  newsItemCategory: `text-[black] text-xs font-semibold`,
